...
async function testEndpointsCestaPedido() {
  ...
  try {
    ...
    // 7. Obtener todas las cestas (admin)
    console.log('\n7️⃣ Obteniendo todas las cestas (admin)...');
    ...
    // 8. Actualizar cesta (cliente)
    console.log('\n8️⃣ Actualizando cesta...');
    ...
    // 11. Probar acceso a cesta de otro usuario (debe fallar)
    console.log('\n1️⃣1️⃣ Probando acceso a cesta de otro usuario...');
    try {
    ...
    // 12. Eliminar cesta (cliente)
    console.log('\n1️⃣2️⃣ Eliminando cesta...');
